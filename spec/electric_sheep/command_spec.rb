...
describe ElectricSheep::Command do
  ...
  describe CommandKlazz do
    ...
    it 'makes initialization options available' do
      command = subject.new(mock, logger = mock, shell = mock, mock)
